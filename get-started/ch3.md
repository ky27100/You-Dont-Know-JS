...
But functions also have another characteristic besides their scope that influences what they can access. This characteristic is best described as an :boom:***execution context***, and it's exposed to the function via its `this` keyword.
